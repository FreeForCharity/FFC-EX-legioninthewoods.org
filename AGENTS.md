# AI Agent Instructions: FFC-EX-legioninthewoods.org
...
These sites deploy to `https://freeforcharity.github.io/FFC-EX-legioninthewoods.org/` and optionally to a custom domain if one is configured for this repo.
