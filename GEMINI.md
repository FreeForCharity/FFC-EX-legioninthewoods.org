# Gemini Instructions: FFC-EX-legioninthewoods.org

Hey Gemini! Welcome to FFC-EX-legioninthewoods.org.

**Project:** FFC-EX-legioninthewoods.org -- a Free For Charity nonprofit website for legioninthewoods.org
...
The site deploys to `https://freeforcharity.github.io/FFC-EX-legioninthewoods.org/` (and your custom domain if configured). The `assetPath()` function from `src/lib/assetPath.ts` handles this automatically.
